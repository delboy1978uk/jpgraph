...
class Graph
{
     ...
     * @param $aNormal
     * @param string $aBold
     * @param string $aItalic
     * @param string $aBoldIt
     */
    ...
    /**
     * @param bool $aDrawPlotFrame
     * @param array $aPlotFrameColor
     * @param int $aPlotFrameWeight
     */
    ...
    /**
     * @param bool $aDrawImgFrame
     * @param array $aImgFrameColor
     * @param int $aImgFrameWeight
     */
    ...
    /**
     * @param $aType
     * @param string $aXFColor
     * @param string $aXColor
     * @param string $aYFColor
     * @param string $aYColor
     */
    ...
    /**
     * @param string $aBackColor
     * @param int $aStyle
     * @param int $aFrameStyle
     * @param string $aFrameColor
     * @param int $aFrameWeight
     * @param int $aBevelHeight
     * @param bool $aEnable
     */
