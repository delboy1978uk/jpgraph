...
class GTextTable
{
    ...
    public function SetImage($aFileR1, $aScaleC1 = null, $aMixR2 = null, $aC2 = null, $aFile = null, $aScale = 1.0, $aMix = 100)
    {
        ...
        for ($i = $aFileR1; $i <= $aMixR2; ++$i) {
            for ($j = $aScaleC1; $j <= $aC2; ++$j) {
    ...
    {
        if ($aC1 !== null && $aR2 !== null && $aC2 !== null && $aO !== null) {
            $this->_chkR($aArgR1);
            $this->_chkC($aC1);
            $this->_chkR($aR2);
            $this->_chkC($aC2);
    ...
    /**
     * @param null $aR1HAlign
     * @param null $aC1VAlign
     * @param null $aR2
     * @param null $aC2
     * @param null $aHArg
     * @param string $aVArg
